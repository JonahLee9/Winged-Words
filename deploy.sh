...
echo "Building the Flutter web app with base href /Winged-Words/..."
flutter build web --release --base-href="/Winged-Words/" #change '/myappRepo/' to the name of the github repo of your project
...
echo "Deployment complete! Visit: https://jonahlee9.github.io/Winged-Words/" #change to your username in the link